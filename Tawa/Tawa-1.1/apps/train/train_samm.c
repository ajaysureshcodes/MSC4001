/* "fast" training progrem using SAMM models */
#include "stdio.h"
#include "stdlib.h"
#include "assert.h"
#include "io.h"
...
usage (void)
{
    fprintf (stderr,
	     ...
	     "\n"
	     "options:\n"
	     "  -C\tChange type of model to PPM (default is SAMM)\n"
...
main(int argc, char *argv [])
{
    ...
    model = TLM_create_model (TLM_SAMM_Model, title, alphabet_size, order, escape_method);
